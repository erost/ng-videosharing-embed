var videoApp = angular.module('videoPlayer', []);

videoApp.filter('whitelist', function () {
...
videoApp.filter('videoOptions', function () {
...
videoApp.service('PlayerConfig', function () {
...
videoApp.factory('RegisteredPlayers', function (PlayerConfig) {
    var configurations = {
        youtube: {
            options: {
                autoplay: 0,
...
videoApp.directive('embedVideo', function ($filter, RegisteredPlayers) {
    return {
        restrict: "A",
